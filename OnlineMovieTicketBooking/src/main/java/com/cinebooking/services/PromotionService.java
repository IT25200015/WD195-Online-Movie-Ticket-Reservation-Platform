...
public class PromotionService {
    ...
    public PromotionService(String rootPath) {
        ...
        this.filePath = "/Users/lakshithadilshan/Downloads/WD195-Online-Movie-Ticket-Reservation-Platform-main/OnlineMovieTicketBooking/data/promotions.txt";
        ensureFileExists();
    }
    ...
    public List<Promotion> getActiveValidPromotions() {
        return getAllPromotions().stream()
                .filter(p -> p.isValidForUse(0)) // checking without amount limitation to show it
