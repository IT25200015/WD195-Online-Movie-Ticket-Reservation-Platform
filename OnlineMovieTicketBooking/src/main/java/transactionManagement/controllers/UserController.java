...
import transactionManagement.dao.UserDAO;
import transactionManagement.dao.UserDAOFile;
import transactionManagement.models.Admin;
import transactionManagement.models.Customer;
...
public class UserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("profile".equals(action)) {
            ...
            transactionManagement.models.User loggedUser = (transactionManagement.models.User) session.getAttribute("user");

            if (loggedUser != null && "Admin".equals(loggedUser.getRole())) {
                UserDAO userDAO = new UserDAOFile();
                java.util.List<transactionManagement.models.User> userList = userDAO.getAllUsers();

                String searchQuery = request.getParameter("searchQuery");
                if (searchQuery != null && !searchQuery.trim().isEmpty()) {
                    String query = searchQuery.trim().toLowerCase();
                    java.util.List<transactionManagement.models.User> filteredUsers = new java.util.ArrayList<>();
                    for (transactionManagement.models.User u : userList) {
                ...
                java.util.Collections.sort(userList, new java.util.Comparator<transactionManagement.models.User>() {
                    @Override
                    public int compare(transactionManagement.models.User u1, transactionManagement.models.User u2) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //  login an existing user
                ...
                // check database
                transactionManagement.models.User loggedUser = userDAO.loginUser(email, password);
