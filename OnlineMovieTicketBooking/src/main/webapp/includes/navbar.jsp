    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="movies.jsp">Movies</a></li> <li class="nav-item"><a class="nav-link" href="booking.jsp">Book Tickets</a></li> <li class="nav-item"><a class="nav-link" href="promotions.jsp">Offers</a></li> <li class="nav-item"><a class="nav-link" href="reviews.jsp">Reviews</a></li> <li class="nav-item"><a class="btn btn-outline-light ms-lg-3" href="login.jsp">Login</a></li> </ul>
        </div>
    </div>
</nav>
